...
VAR prev_lvl_choice = "false" //UPDATELD //load ez az előzőből jön, annak a nevére kell változtatni
         ...
         * Can't find one? -> conv3
            === conv3 ==
                    {guest_name}: I can, there is just too many and I can't decide.
                         ...
                         * Do you gave a thought about Gauguin? -> Good
                         * Sorry, I don't know any artist. -> Ignore
                         * Here is an app that writes everything, you don't have to. -> Epic
